...
function Search() {
  ...
  return (
    <div className='flex flex-col md:flex-row'>
        <div className='p-7 border-b-2 md:border-r-2 border-slate-200 md:min-h-screen'>
            <form className='flex flex-col gap-8' onSubmit={handleSumbit}>
                ...
                <div className='flex items-center gap-2 ' >
                    ...
                    <select defaultValue="created_at_desc" id="sort_order" className='border-0 rounded-lg p-3 bg-white'
                        onChange={handleChange}>
        ...
        <div className=''>
           <h1 className='text-3xl font-semibold p-3 text-slate-600 mt-5'>
                Listing results:
            </h1>
        </div>
    </div>
